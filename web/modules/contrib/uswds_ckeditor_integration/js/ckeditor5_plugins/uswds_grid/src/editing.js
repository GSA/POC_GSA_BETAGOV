  ...
  _defineConverters() {
    ...
    conversion.for('downcast').elementToElement({
      ...
      view: (modelElement, { writer }) => {
        ...
        const container = writer.createContainerElement('div', gridAttributes);
    ...
    conversion.for('downcast').elementToElement({
      ...
      view: (modelElement, { writer }) => {
        const gridAttributes = {
          class: modelElement.getAttribute('class') || 'grid-container',
        };
        const container = writer.createContainerElement('div', gridAttributes);
        writer.setCustomProperty('uswdsGridContainer', true, container);
        return toWidget(container, writer, { label: 'USWDS Grid Container' });
      },
    });
